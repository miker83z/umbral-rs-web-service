...
const test = async () => {
  ...
  const { resp: res0 } = (
    await auth.keyrefresh({
        ...
        parties: 5,
        threshold: 3,
        dh_point:[3, 248, 92, 16, 145, 125, 119, 97, 185, 247, 94, 147, 17, 90, 84, 1, 142, 9, 237, 202, 165, 133, 107, 110, 221, 41, 181, 30, 142, 238, 111, 228, 107],
        precursor: [2, 73, 132, 47, 131, 129, 0, 31, 112, 153, 107, 119, 88, 77, 130, 198, 122, 160, 149, 24, 220, 229, 127, 18, 206, 210, 175, 208, 117, 133, 182, 202, 186],
        delegatee_key: [2, 177, 68, 125, 44, 113, 169, 50, 229, 3, 234, 78, 206, 105, 227, 167, 244, 76, 218, 133, 255, 29, 140, 140, 160, 125, 132, 165, 145, 88, 61, 6, 139],
        id:  "CFB8AA869E8941B58E680B88D9673EFBA345A38D37B00D6ADE35B00F67A08F80",
        sk: [44, 170, 187, 26, 236, 53, 108, 172, 179, 38, 244, 251, 72, 246, 178, 208, 7, 129, 111, 206, 4, 55, 22, 249, 136, 189, 115, 168, 246, 217, 245, 116]
    })
  );
  ...
  const { resp: res1 } = (
    await auth.keyrefresh({
      ...
      sk: [143, 95, 152, 35, 162, 113, 72, 18, 107, 104, 187, 44, 134, 2, 107, 37, 248, 161, 234, 237, 41, 72, 248, 177, 120, 147, 58, 77, 130, 244, 100, 142]
    })
  ).data;
  ...
  const { resp: res2 } = (
    await auth.keyrefresh({
      ...
      sk: [37, 182, 132, 105, 81, 179, 163, 95, 248, 10, 29, 72, 235, 128, 54, 200, 95, 99, 60, 44, 151, 201, 75, 31, 130, 181, 23, 33, 171, 158, 153, 116]
    })
  ).data;
  ...
  const { resp: res3 } = (
    await auth.keyrefresh({
      ...
      sk:[78, 191, 113, 132, 124, 232, 199, 128, 147, 26, 234, 133, 69, 124, 36, 147, 124, 15, 202, 38, 202, 103, 215, 32, 136, 162, 49, 241, 240, 111, 68, 204]
    })
  ).data;
  ...
  sk:[116, 141, 216, 95, 237, 86, 68, 78, 133, 106, 213, 208, 119, 92, 122, 33, 183, 143, 147, 147, 197, 71, 230, 208, 109, 229, 62, 70, 200, 4, 12, 39]
